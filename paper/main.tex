...
The problem appears in short, high-prior written forms. In a snooker report, \emph{13-11} should be read as a score, i.e., \emph{十三比十一}, rather than a range-like reading such as \emph{十三至十一}. In a military report, \emph{伊尔-76} is an aircraft model, not a negative number. In technology and automotive news, \emph{640kW}, \emph{350Wh/kg}, or \emph{88VIP} require domain conventions. These errors are often fluent: a listener hears the wrong reading, but the transcript can still look correct.
