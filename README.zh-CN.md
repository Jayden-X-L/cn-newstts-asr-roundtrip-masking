...
扩展预印本已于 2026 年 7 月 22 日提交至 arXiv，目前处于分类审核阶段。本仓库于 2026 年 6 月 22 日创建，初始设为 private，以完成必要的前置审核与发布流程；2026 年 7 月 26 日，仓库转为 public，支撑材料同步公开发布。arXiv 正式上线后将补充论文编号。
